...
select count(1)
 ...
 where definc = ie_def.definc
   ...
   and upper(paramname) = 'IN_SUBSTRING_LENGTH';
if cntRows != 0 then
...
values
(ie_def.definc,ie_line.lineinc,ie_maxchunk.chunkinc,
 0,'IN_SUBSTRING_POSITION',
 1517,7,
 'Substring Position','N'
);
...
select count(1)
 ...
 where definc = ie_def.definc
   and lineinc = ie_line.lineinc
   and chunkinc = ie_maxchunk.chunkinc
   and upper(paramname) = 'SUBSTRING_LENGTH';
if cntRows != 0 then
...
(definc,lineinc,chunkinc,
 chunktype,paramname,
 offset,length,
 description,chunkdecimals,mappings)
values
(ie_def.definc,ie_line.lineinc,ie_maxchunk.chunkinc,
 0,'SUBSTRING_POSITION',
 1517,7,
 'Substring Position','9','9999999'
);
