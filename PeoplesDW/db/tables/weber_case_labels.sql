...
create index weber_case_labels_ordidx
   on weber_case_labels(orderid, shipid);

create index weber_case_labels_lodidx
   on weber_case_labels(loadno);

create index weber_case_labels_wavidx
   on weber_case_labels(wave);
