create or replace view stkstat846byis_hdr
(
    facility,
    custid,
    facility_name,
...
comment on table stkstat846byis_hdr is '$Id: stockstatus846views.sql 19058 2017-07-31 20:27:12Z kevinh $';

create or replace view stkstat846byis_dtl
(
    facility,
    custid,
    item,
...
select distinct
    ...
    CI.itmpassthrunum09,
    CI.itmpassthrunum10
  from custitemtot T,custitem CI, custitemupcview U, stkstat846byis_hdr S
...
comment on table stkstat846byis_dtl is '$Id: stockstatus846views.sql 19058 2017-07-31 20:27:12Z kevinh $';

create or replace view stkstat846byis_qty
(
    facility,
    custid,
    item,
...
select
    ...
    nvl(I.uom,S.baseuom),
    sum(nvl(qty,0))
  from custitemtot I, stkstat846byis_dtl S
...
comment on table stkstat846byis_qty is '$Id: stockstatus846views.sql 19058 2017-07-31 20:27:12Z kevinh $';

create or replace view stkstat846byis_lip
(
    facility,
    custid,
    lpid,
...
comment on table stkstat846byis_lip is '$Id: stockstatus846views.sql 19058 2017-07-31 20:27:12Z kevinh $';
