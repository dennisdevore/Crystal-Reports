create or replace view DRE_BOLRPT_PRELIM ( OH_ORDERID, 
...
IATATERTIARYCHEMCODE, IATAQUATERNARYCHEMCODE,
GROSSWEIGHT, OH_PRONO, MFG_DATE, SP_USERITEM1, LINEORDER, OH_CONSIGNEE, OH_SHIPTO )  as
select
OH.orderid,
OH.shipid,
OH.entrydate,
...
comment on table DRE_BOLRPT_PRELIM is '$Id$';
exit;
