create or replace view bolrptmedview
(
OH_ORDERID
,OH_SHIPID
,OH_ENTRYDATE
...
select
       ...
       decode(OH.shipterms,'PPD', CU.name,
                'COL', CN.name,
                '3RD',
       ...
       STRM.abbrev,
        ...
        OD.QTYENTERED,
        OD.UOMENTERED,
        zcu.equiv_uom_qty(OD.custid,OD.item,OD.uomentered,
         OD.qtyentered,zci.baseuom(OD.custid,OD.item))
from
    orderhdr OH,
    consignee CN,
    consignee CNS,
...
/
comment on table bolrptmedview is '$Id';
exit
