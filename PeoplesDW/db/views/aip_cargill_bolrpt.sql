...
CREATE OR REPLACE VIEW AIP_CARGILL_BOLRPT ( OH_ORDERID, 
...
OD_ITEM, SP_ITEM, OD_QTYSHIP, OD_WEIGHTSHIP, 
OD_LOTNUMBER, OD_LOTNUMBER_NULL, FAC_NAME, FAC_ADDR1, 
...
ST_ABBREV, STRM_ABBREV, PO_NUMBER, DATE_SHIPPED, 
QTY_ORDERED, QTY_ENTERED, UOM_ENTERED,GROSSWEIGHT,CN_SHIPTOID,CN_CONTACT,CN_PHONE,
OH_CONSIGNEE, OH_SHIPTO) AS select
       OH.orderid,
       OH.shipid,
       OH.entrydate,
       OH.apptdate,
       ...
       STRM.abbrev,
        ...
        OD.QTYENTERED,
        OD.UOMENTERED,
	sum(SP.weight + (zlbl.uom_qty_conv(od.custid,od.item,SP.quantity,od.uom,ci.baseuom) * nvl(ci.tareweight,0))),
      CNS.consignee,
...
comment on table AIP_CARGILL_BOLRPT is '$Id$';
