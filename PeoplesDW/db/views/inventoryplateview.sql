create or replace view inventoryplateview
(
LPID,
ITEM,
CUSTID,
...
comment on table inventoryplateview is '$Id$';
  
create or replace view pho_inventoryplateview
(
LPID,
ITEM,
CUSTID,
...
plate.lastuser,
plate.lastupdate,
zlbl.uom_qty_conv(plate.custid,plate.item,plate.quantity,plate.unitofmeasure,'PCS'),
zlbl.uom_qty_conv(plate.custid,plate.item,plate.quantity,plate.unitofmeasure,'CTN')
from plate, custitem
where plate.custid = custitem.custid (+)
and plate.item = custitem.item (+)
and plate.status not in ('D','P','I')
...
shippingplate.lastuser,
shippingplate.lastupdate,
zlbl.uom_qty_conv(shippingplate.custid,shippingplate.item,shippingplate.quantity,shippingplate.unitofmeasure,'PCS'),
zlbl.uom_qty_conv(shippingplate.custid,shippingplate.item,shippingplate.quantity,shippingplate.unitofmeasure,'CTN')
from facility, custitem, shippingplate
where shippingplate.custid = custitem.custid (+)
  and shippingplate.item = custitem.item (+)
  and shippingplate.status in ('P','S','L','FA')
...
comment on table pho_inventoryplateview is '$Id$';
