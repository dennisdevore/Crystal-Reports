create or replace view multiorderhdrview
(
BILLOFLADING,
PRIORITY,
WEIGHTCOMMIT,
...
orderhdr.rowid,
orderhdr.shipshort,
zci.total_cases(orderhdr.orderid,orderhdr.shipid)
...
comment on table orderhdrview is '$Id: orderhdrview.sql 9191 2012-12-04 07:19:45Z brianb $';
