create or replace view lbl_hf_walmart_cs_view
(
   orderid,
   shipid,
   custname,
...
select
   ...
   OD.item,
   '1'||substr(zedi.get_sscc14_code('0','733652'|| substr(LPAD(OD.dtlpassthruchar01,300,'0'),-5,5)),2),
   OD.seq,
   OD.seqof
from orderhdr OH,
     consignee CN,
...
comment on table lbl_hf_walmart_cs_view is '$Id';
