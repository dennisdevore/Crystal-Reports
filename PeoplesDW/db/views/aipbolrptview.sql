create or replace view aip_bolrpt
(
       OH_orderid,
       OH_shipid,
       OH_entrydate,
...
where
    ...
    OH.orderstatus = '9') and
	 SP.fromlpid = PL.lpid and
	 PL.loadno = LD2.loadno (+)
group by
       OH.orderid,
       OH.shipid,
       OH.entrydate,
...
comment on table aip_bolrpt is '$Id$';
